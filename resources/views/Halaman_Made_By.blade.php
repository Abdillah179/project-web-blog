...
<body id="body">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between tulisan-nusantaraaa">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center mb-5">
                        <h1 class="page-title">Made By</h1>
                    </div>
                </div>

                <div class="row gy-4 d-flex justify-content-center">
                    <img src="{{ asset('made-by/profil.jpg')  }}" alt="" height="300px" class="rounded-circle gambar" style="width: 360px;">
                </div>


                <div class="row mt-3">
                    <h1 class="text-center">Muhammad Abdillah Asyhar</h1>
                    <h1 class="text-center">Back End Web Developer</h1>
                </div>

                <div class="row mt-5">
                    <h1 class="text-center text-kata-kata">'Manusia modern akan selalu menjadi manusia yang bergantung dengan teknologi. Tetapi manusia yang bersikap sederhana dan produktif, akan menjadi orang yang mudah dan berhasil. <br> <br> - Baro Indra'</h1>

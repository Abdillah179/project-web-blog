                ...
                <div class="row">
                    <div class="col-md-12 post-content" data-aos="fade-up">
                        ...
                        <div class="single-post">
                            <div class="post-meta"><span class="date">{{ $dataslug->slug_category }}</span> <span class="mx-1">&bullet;</span> <span>{{ $dataslug->published_at }}</span><span class="mx-1">&bullet;</span> <span>{{ $dataslug->negara }}</span></div>
                            <h1 class="mb-5">{{ $dataslug->title }}</h1>
                            <img src="{{ asset('storage/' . $dataslug->blog_image) }}" alt="" class="img-fluid">
                            <p>{!! $dataslug->body !!}</p>

                ...
                <div class="row">
                    <div class="col-md-12 post-content" data-aos="fade-up">
                        ...
                        <div class="single-post">
                            <div class="post-meta"><span class="date">{{ $detaildatapostbloguser->slug_category }}</span> <span class="mx-1">&bullet;</span> <span>{{ $detaildatapostbloguser->published_at }}</span><span class="mx-1">&bullet;</span> <span>{{ $detaildatapostbloguser->negara }}</span></div>
                            <h1 class="mb-5">{{ $detaildatapostbloguser->title }}</h1>
                            <img src="{{ asset('storage/' . $detaildatapostbloguser->blog_image) }}" alt="" class="img-fluid">
                            <p>{!! $detaildatapostbloguser->body !!}</p>
